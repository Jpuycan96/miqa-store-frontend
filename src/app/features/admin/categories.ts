...
export class AdminCategories {
 ...
 edit(c?:AdminCategory){this.id.set(c?.id??null);this.manualSlug=!!c;this.form.reset(c?{...c,description:c.description??'',catalogHeadline:c.catalogHeadline??'',catalogDescription:c.catalogDescription??''}:{name:'',slug:'',description:'',catalogHeadline:'',catalogDescription:'',active:true,displayOrder:0});this.editing.set(true);this.error.set('');this.message.set('');}
