...
@Component({
 ...
 styles:`.whatsapp{position:fixed;right:24px;bottom:max(24px,env(safe-area-inset-bottom));z-index:25;display:grid;place-items:center;width:54px;height:54px;border-radius:50%;background:#087b3e;color:white;box-shadow:0 3px 12px #061b4f20;transition:background .18s}.whatsapp:hover{background:#066633}.whatsapp svg{width:29px;height:29px}.whatsapp:focus-visible{outline:3px solid #061b4f;outline-offset:4px}@media(max-width:767px){.whatsapp{right:12px;bottom:max(12px,env(safe-area-inset-bottom));width:48px;height:48px}}`,
