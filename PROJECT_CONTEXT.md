...
- Hero móvil: las tres piezas comparten un contenedor centrado que escala al 82% bajo 768 px, conservando posiciones relativas y animaciones individuales; desktop mantiene escala original. En Servicios se elimina el título «Tecnología, precisión y experiencia»; «Lo que hacemos» conserva la identificación accesible de la sección, sin sustituir el texto eliminado.
...
- Hero más compacto: H1 de `clamp(58px, 7.2vw, 102px)` a `clamp(36px, 4.4vw, 64px)`, menos padding/gaps y separación de acciones/nota. Área visual mínima un 20% menor (320/408/456 px frente a 400/510/570). Altura de Hero comprobada: 793 px a 360, 757 a 390, 705 a 430, 504 a 768/1024 y 560 a 1440/1920. En móvil las tres imágenes comienzan dentro del primer viewport: área visual desde y≈519/482/430 en 360×800, 390×844 y 430×932, respectivamente.
