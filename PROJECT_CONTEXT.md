...
- Desde 1280 px, hasta seis categorías públicas de ProductCatalog en el orden de la API y TODOS ocupan una cuadrícula central, seguidas de cotización y búsqueda. Categorías a 15 px/peso 600, con nombres completos en hasta dos líneas; franja superior a 13 px. Header con margen local de 32 px por lado, sin el antiguo límite de 1720 px; max-width global intacto. Bajo 1280 px, hamburguesa con enlaces superiores, categorías, Todos, búsqueda y cotización; franja superior oculta bajo 768 px y márgenes móviles de 16 px.
